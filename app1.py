# Drag & Drop Machine Learning App with Streamlit and Python
# Source = https://blog.jcharistech.com/2019/12/25/building-a-drag-drop-machine-learning-app-with-streamlit/
...
def main():
	...
	if choice == 'EDA':
		...
		st.subheader("About")
		st.write ("Writen in Streamlit version 0.52.2")
